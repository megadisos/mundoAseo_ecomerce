...
function Contacto(props){
    ...
    return(
        ...
        <div className="row mb-5">
        <div class="col-12">
              <center><div className="map"><iframe width="50%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=es&amp;q=Kra%20114%20No%20152d-82+(El%20mundo%20del%20aseo)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div></center>
              </div>
              </div>
